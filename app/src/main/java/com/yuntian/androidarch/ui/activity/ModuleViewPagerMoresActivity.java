...
import com.yuntian.androidarch.ui.adapter.BaseFragmentPagerAdapter;
import com.yuntian.androidarch.ui.adapter.BaseFragmentStatePagerAdapter;
...
public class ModuleViewPagerMoresActivity extends BaseActivity {
    ...
    private void initTab(boolean isInit) {
        titles = new String[]{"ModuleA", "ModuleB", "ModuleC", "ModuleD", "ModuleE", "ModuleF"};
        ...
        BaseFragmentStatePagerAdapter fragmentPagerAdapter = new BaseFragmentStatePagerAdapter(this, fragmentList);
