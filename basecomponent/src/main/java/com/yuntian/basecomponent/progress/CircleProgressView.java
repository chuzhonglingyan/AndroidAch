...
public class CircleProgressView extends View {
    ...
    private void obtainAttrs(Context context, AttributeSet attrs){
        ...
        mStartProgress = typedArray.getInt(R.styleable.CircleProgressView_cp_start_progress,0);
        mEndProgress = typedArray.getInt(R.styleable.CircleProgressView_cp_end_progress,60);
        mStartColor = typedArray.getColor(R.styleable.CircleProgressView_cp_start_color, getContext().getResources().getColor(R.color.colorPrimary));
        mEndColor = typedArray.getColor(R.styleable.CircleProgressView_cp_end_color, getContext().getResources().getColor(R.color.colorAccent));
        fillEnabled = typedArray.getBoolean(R.styleable.CircleProgressView_cp_isFilled, false);
        trackEnabled = typedArray.getBoolean(R.styleable.CircleProgressView_cp_isTracked, false);
        circleBroken = typedArray.getBoolean(R.styleable.CircleProgressView_cp_circleBroken, true);
        mProgressTextColor = typedArray.getColor(R.styleable.CircleProgressView_cp_progressTextColor,getResources().getColor(R.color.colorAccent));
        mProgressTextSize = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_cp_progressTextSize,getResources().getDimensionPixelSize(R.dimen.default_progress_text_size));
        mTrackWidth = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_cp_track_width, getResources().getDimensionPixelSize(R.dimen.default_trace_width));
        mAnimateType = typedArray.getInt(R.styleable.CircleProgressView_cp_animateType, ACCELERATE_DECELERATE_INTERPOLATOR);
        mTrackColor = typedArray.getColor(R.styleable.CircleProgressView_cp_trackColor, getResources().getColor(R.color.default_track_color));
        textVisibility = typedArray.getBoolean(R.styleable.CircleProgressView_cp_progressTextVisibility, true);
        mProgressDuration = typedArray.getInt(R.styleable.CircleProgressView_cp_progressDuration, 1200);
        mScaleZoneLength = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_cp_scaleZone_length, getResources().getDimensionPixelSize(R.dimen.default_zone_length));
        mScaleZoneWidth = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_cp_scaleZone_width, getResources().getDimensionPixelSize(R.dimen.default_zone_width));
        mScaleZonePadding = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_cp_scaleZone_padding, getResources().getDimensionPixelSize(R.dimen.default_zone_padding));
        mScaleZoneCornerRadius = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_cp_scaleZone_corner_radius, getResources().getDimensionPixelSize(R.dimen.default_zone_corner_radius));
        isGraduated = typedArray.getBoolean(R.styleable.CircleProgressView_cp_isGraduated, false);
